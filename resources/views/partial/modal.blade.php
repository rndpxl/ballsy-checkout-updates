    ...
    <div class="micromodal__overlay" tabindex="-1" data-micromodal-close>
        <div class="micromodal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
            ...
            <main class="micromodal__content" id="modal-1-content">
                <div class="refer_img">
                    <img src="https://cdn.shopify.com/s/files/1/1506/3870/files/sh_476.jpg?17061543826047409268">
                </div>
                <div>
                    <p>
            ...
            <footer class="micromodal__footer">
                <div>
                    ...
                    <div class="referral-explanation">
                        <p>
                            <b>Referring friends is easy.</b> Copy and paste the above referral
                            code into a social media post or email. When friends buy
                            through your social media link you'll both get discounts!
                        </p>
                    </div>
                </div>
                <div>
