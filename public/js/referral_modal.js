...
var ReferralModal = function () {
    ...
    _createClass(ReferralModal, null, [{
        ...
        value: function showReferral(referral_url) {
            ...
            __WEBPACK_IMPORTED_MODULE_1_jquery___default()("#share").jsSocials({
                showLabel: false,
                showCount: false,
                shareIn: "popup",
            ...
            var $modal = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#modal-1.micromodal');

            $modal.find('.copyable-text').html(referral_url);
            $modal.find('.copy-btn').data('clipboard-text', referral_url);

            __WEBPACK_IMPORTED_MODULE_1_jquery___default()(document).on('click', '.copy-btn', function (e) {
                var text = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.target).data('clipboard-text');
                _this.copyTextToClipBoard(e.target, text);

                var $button = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(e.target);
                $button.text('Copied!');
                setTimeout(function () {
                    $button.text('Copy');
                }, 1000);
        ...
        value: function showSignup(first_name, last_name, email, referral_url) {
            ...
            var $modal = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('#modal-signup');
            ...
            $modal.find('#create_customer').on('submit', function (e) {
                ...
                __WEBPACK_IMPORTED_MODULE_1_jquery___default.a.post({
